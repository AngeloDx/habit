            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="wizard-container">
                    ...
                    <div class="card wizard-card" data-color="blue" id="wizardProfile">
                        <form  method="post" action="{{ route('categoria.store') }}" id="msg_form" autocomplete="off" enctype="multipart/form-data">
                          @csrf
                          <input type="text" name="nome" placeholder="introduza o nome"/>
                          <input type="file" name="capa_cate" multiple />

                            <textarea autofocus name="descricao"></textarea>
