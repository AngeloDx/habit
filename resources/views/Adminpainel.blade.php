    ...
    <div class="main-panel">
      ...
      <div class="content">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"> {{ $userCount }}<sup>+</sup><p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{$propriedadeCount}}<p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{$categoriaCount}}<p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <th class="text-right">Preco</th>
                          <th class="text-right">Intencao</th>
                        <tbody>
                          @foreach($propriedade as $propriedade)
                          <tr>
                            <td>
                              <div class="flag">
        ...
        <div class="row">
            ...
            <div class="card  w-100">
              <div class="card-header ">
                <h4 class="card-title">Lista de catgorias</h4>
                <p class="card-category"></p>
              </div>
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="w-100">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table">
                        <th>Imagens</th>
                        <th> Nome</th>
                        <th class="text-right"> Descricao</th>
                        <th class="text-right">  <a href="{{ route('categoria.create' ) }}" class="btn btn-sm btn-warning"><span class=""></span> Criar</a></th>
                        <tbody>
                          @foreach($categoria as $categoria)
                          <tr>
                            <td>
                              <div class="flag">
                              <img src="{{ URL::to('/') }}/images/{{ $categoria->capa }}"  width="60" height="50" />
                              </div>
                            </td>
              ...
              <div class="card-body ">
                <div class="table-full-width table-responsive">
                  <table class="table">
                    <th>Imagens</th>
                    <th> Nome</th>
                    <th class="text-right">  <a href="{{ route('residencial.create' ) }}" class="btn btn-sm btn-warning"><span class=""></span> Criar</a></th>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="img-row">
                          <div class="img-wrapper">
                            <img src="{{ URL::to('/') }}/residencial/{{ $residencial->icon }}"  width="60" height="50"/>
                          </div>
                        </td>
                        <td class="text-left">{{$residencial->nome}}</td>
              ...
              <div class="card-body ">
                <div class="table-full-width table-responsive">
                  <table class="table">
                    ...
                    <th class="text-right">  <a href="{{ route('comercial.create' ) }}" class="btn btn-sm btn-warning"><span class=""></span> Criar</a></th>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="img-row">
                          <div class="img-wrapper">
                            <img src="{{ URL::to('/') }}/comercial/{{ $comercial->icon }}"  width="60" height="50"
                          </div>
                        </td>
                        <td class="text-left">{{$comercial->nome}}</td>
                        <td class="td-actions text-right">
                        ...
                        <tbody>
                         @foreach($user as $us)
                          <tr>
                            ...
                            <td>{{$us->email}}</td>
                            <td class="text-right">
                             {{ implode(' , ', $us->roles()->get()->pluck('nome')->toArray())}}
                            </td>
                            <td class="text-right">
                            td3
                            </td>
                            <td  class="text-right">
                              <a href="{{ route('admin.user.edit', $us->id) }}" class="btn btn-sm btn-info float-left"><span class="fa fa-edit"></span> Editar</a>
                          <form action="{{ route('admin.user.destroy', $us) }}" method="post" class="float-left">
